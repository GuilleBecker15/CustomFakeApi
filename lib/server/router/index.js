...
module.exports = function (source) {
  ...
  router.post('/validar', function (req, res) {
    ...
    var passReq = CryptoJS.AES.decrypt(pass, "@bN~Ro)}=Fg_!1z<Ys:umjmP;DP;XW").toString(CryptoJS.enc.Utf8);
    var passBd = CryptoJS.AES.decrypt(resource.pass, "@bN~Ro)}=Fg_!1z<Ys:umjmP;DP;XW").toString(CryptoJS.enc.Utf8);
    if(!!passReq && !!passBd && passReq == passBd){
    ...
    console.log("----------------password de la request-------------------------------");
    console.log(pass);
    console.log("------password de la BD-------");
    console.log(resource.pass);
    console.log("--------password de la request despues de bycrypt-----------------");
    console.log(passReq);
    console.log("------password de la BD despues de decrypt-------");
    console.log(passBd);
