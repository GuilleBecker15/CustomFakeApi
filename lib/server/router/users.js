...
module.exports = function (db, name, opts) {
  ...
  function create(req, res, next) {
    ...
    var passEncrypt = CryptoJS.AES.encrypt(pass, "@bN~Ro)}=Fg_!1z<Ys:umjmP;DP;XW");

    console.log("-----PASS_encrytp-----: "+passEncrypt);
    console.log("-----PASS_encrytp-----: "+passEncrypt.toString());
    
    req.body.pass = passEncrypt.toString();


    console.log("-----BODY_Cambiada-----: "+req.body.pass);
